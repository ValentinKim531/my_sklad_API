...
# Запуск всех служб
CMD service redis-server start && /app/.venv/bin/uvicorn main:fastapi_app --host 0.0.0.0 --port 8000 --reload & /app/.venv/bin/celery -A celery_worker worker --beat --loglevel=info
